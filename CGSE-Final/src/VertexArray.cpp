...
void VertexArray::AddBuffer(const VertexBuffer& vb, const VertexBufferLayout& layout)
{
    ...
    for (unsigned int i = 0; i < elements.size();i++) {
        ...
        //H-These lines enable the GL_ARRAY_BUFFER attributes to be modified inside the shader. So they define the layout and the locations of the specific attributes
